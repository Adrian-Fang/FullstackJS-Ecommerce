...
INSERT INTO `products` (`id`, `productId`, `productName`, `productPrice`, `checked`, `productNum`, `productImg`, `sub_title`, `limit_num`, `description`, `descImg`, `productDetails`) VALUES
