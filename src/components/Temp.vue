        ...
        <v-card-text>
          <v-form ref="regForm" v-model="valid" class="pa-3">
            ...
            <div class="d-flex align-center">
              <v-checkbox class="d-inline-block" v-model="serviceAgreed" required></v-checkbox>
              <span
            ...
            <v-card-actions>
              <v-btn :disabled="isFormValid" block color="success">Create Account</v-btn>
            </v-card-actions>
          </v-form>
        </v-card-text>
      </v-card>
