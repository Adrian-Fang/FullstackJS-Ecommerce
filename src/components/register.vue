        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              ...
              <span v-show="sccu" style="color:#40d505; font-size:16px;"
                ><i class="el-icon-circle-check-outline"></i>注册成功,3秒后跳转至登录！</span
              >
            </div>
            <ul>
